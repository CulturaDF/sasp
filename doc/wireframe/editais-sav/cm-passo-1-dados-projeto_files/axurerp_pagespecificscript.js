...
var PageName = 'cm-passo-1-dados-projeto';
var PageId = '13c237eb253d47b7a35b5d9213ca5b65'
var PageUrl = 'cm-passo-1-dados-projeto.html'
document.title = 'cm-passo-1-dados-projeto';
var PageNotes = 
{
...
if ((GetCheckState('u85')) == (true)) {

	SetPanelVisibility('u82','','fade',100);

}
else
if ((GetCheckState('u85')) == (false)) {

	SetPanelVisibility('u82','hidden','fade',100);
...
if (true) {
	...
	self.location.href="cm-passo-2.1-solicita-cpf-diretor.html" + GetQuerystring();
