...
var PageName = 'passo-1-dados-projeto-pj';
var PageId = 'e6e73dfa3dcc4e078069541d6bad9b58'
var PageUrl = 'passo-1-dados-projeto-pj.html'
document.title = 'passo-1-dados-projeto-pj';
var PageNotes = 
{
...
if ((GetCheckState('u103')) == (true)) {
	...
	SetPanelVisibility('u96','','fade',100);

}
else
if ((GetCheckState('u103')) == (false)) {

	SetPanelVisibility('u96','hidden','fade',100);
...
if (true) {
	...
	self.location.href="passo-2.1-solicita-cpf-diretor-pj.html" + GetQuerystring();
...
if (true) {
	...
	SetPanelVisibility('u5','hidden','fade',100);
...
if (true) {
	...
	SetPanelVisibility('u5','toggle','fade',100);
