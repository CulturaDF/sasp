...
var PageName = 'home-administracao-edital';
var PageId = 'c8f2e635b8604cf5a183e92bd019b8ad'
var PageUrl = 'home-administracao-edital.html'
document.title = 'home-administracao-edital';
var PageNotes = 
{
...
if (true) {
	...
	self.location.href="lista-distribuir-deferidos-comissao.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="distribuir-inscricao-de-curta-metragem.html" + GetQuerystring();
...
if (bIE) u2.attachEvent("onchange", Changeu2);
else u2.addEventListener("change", Changeu2, true);
function Changeu2(e)
{
windowEvent = e;
...
if (true) {
	...
	self.location.href="lista-comissao-habilitacao.html" + GetQuerystring();
